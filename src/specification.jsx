  ...
  return (
    <table border="1">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <div>
              <ul>
                <li>
                  ARM9 processor with 32-Bit Arm &amp; 16-Bit Thumb instruction
                  sets
                  <ul>
                    <li>400 MHz</li>
        ...
        <tr>
          <th>Packet Data</th>
          <td>Up to 100 Mbps downlink, Up to 50 Mbps uplink</td>
        </tr>
        <tr>
          ...
          <td>
            <div>
              <ol>
                ...
                <li>
                  GNSS/GPS Magnet mount
                  <ul>
                    <li>Input Voltage: 3.0V±0.3V</li>
                    <li>
                      Power Consumption: 15mA Typical (+25⁰C±5⁰C) 20mA Max
                      (-40⁰C≈+85⁰C)
                    </li>
        ...
        <tr>
          <th>LoRa Channel Plan Support</th>
          <td>AS 920 – 925 MHz</td>
        </tr>
        <tr>
          <th>LoRaWan Protocol Support</th>
          <td>
            LoRaWAN 1.0, 1.0.1 and 1.02 supported / LoRaWAN 1.1 Support Q1, 2019
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <th>Sensitivity</th>
          <td>-140dbm@SF12BW124kHz</td>
        </tr>
        <tr>
          <th>Storage</th>
          <td>Micro SD – 32 GB max size storage</td>
        </tr>
        <tr>
          <th>Input Voltage</th>
          <td>48V POE, IEEE 802.3af (PoE) and IEEE 802.3at (PoE+)</td>
        </tr>
        <tr>
        ...
        <tr>
          <th>Ethernet</th>
          <td>1 RJ45 Ethernet 10/100 Port POE</td>
        </tr>
        <tr>
          <th colSpan="2">
            <div>
        ...
        <tr>
          <th>
            <div>
              Dimensions with Antenna <br /> (L x W x H)
            </div>
          </th>
        ...
        <tr>
          ...
          <td>20% to 90%, non-considensing</td>
        </tr>
        <tr>
          <th>WaterProof</th>
          <td>IP67</td>
